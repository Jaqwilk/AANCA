...
<main id="main">
  ...
  <section class="section" id="use">
    <div class="repo-shell">
      <div class="reproduction-intro reveal"><h2>Read the evidence first; run the software when a deeper check is needed.</h2><p>The checked-in article opens without a dataset, model run or GPU. <code>present_demo.py --verify-only</code> verifies the five-file presentation package; it does not retrain a model or recalculate any primary result. The separate synthetic path exercises the portable software workflow.</p><p>The public release provides the saved OOF, ranking, bootstrap and restoration evidence needed to recalculate H1-H7. Retraining from images remains a separate operation requiring a lawful PanNuke copy; the repository never downloads the dataset silently or relaxes the scientific gates.</p></div>
      <article class="repo-card reveal">
        ...
        <p class="repo-description">The repository contains the scientific specification, source code, cross-platform software checks, synthetic workflows and this checksum-verifiable presentation. The linked release publishes all completed-cell OOF predictions and rankings plus the full statistical and H4 evidence; raw PanNuke binaries and unretained fold checkpoints are not included.</p>
...
<section class="hero" id="top" aria-labelledby="hero-title">
  ...
  <div class="hero-shell">
    <div class="hero-copy">
      ...
      <div class="hero-byline hero-animate"><span>By <strong>Natan Smogór</strong></span><span>Updated <time datetime="2026-08-20">20 August 2026</time></span></div>
    </div>
